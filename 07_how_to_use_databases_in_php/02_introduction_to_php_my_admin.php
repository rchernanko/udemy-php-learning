...
PHPMyAdmin is a tool that allows us to manage databases...

Need to get the apache web server and mysql database up and running in XAMPP
...
Anyway, as part of this course, we will probably use only the 'Database' and 'Users' tabs...
